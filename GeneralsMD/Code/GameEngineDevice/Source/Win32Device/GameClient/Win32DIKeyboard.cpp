...
{
{ static_cast<HRESULT>(DIERR_ACQUIRED), "DIERR_ACQUIRED" },
{ static_cast<HRESULT>(DIERR_ALREADYINITIALIZED), "DIERR_ALREADYINITIALIZED" },
{ static_cast<HRESULT>(DIERR_BADDRIVERVER), "DIERR_BADDRIVERVER" },
{ static_cast<HRESULT>(DIERR_BETADIRECTINPUTVERSION), "DIERR_BETADIRECTINPUTVERSION" },
{ static_cast<HRESULT>(DIERR_DEVICEFULL), "DIERR_DEVICEFULL" },
{ static_cast<HRESULT>(DIERR_DEVICENOTREG), "DIERR_DEVICENOTREG" },
{ static_cast<HRESULT>(DIERR_EFFECTPLAYING), "DIERR_EFFECTPLAYING" },
{ static_cast<HRESULT>(DIERR_GENERIC), "DIERR_GENERIC" },
{ static_cast<HRESULT>(DIERR_HANDLEEXISTS), "DIERR_HANDLEEXISTS" },
{ static_cast<HRESULT>(DIERR_HASEFFECTS), "DIERR_HASEFFECTS" },
{ static_cast<HRESULT>(DIERR_INCOMPLETEEFFECT), "DIERR_INCOMPLETEEFFECT" },
{ static_cast<HRESULT>(DIERR_INPUTLOST), "DIERR_INPUTLOST" },
{ static_cast<HRESULT>(DIERR_INVALIDPARAM), "DIERR_INVALIDPARAM" },
{ static_cast<HRESULT>(DIERR_MAPFILEFAIL), "DIERR_MAPFILEFAIL" },
{ static_cast<HRESULT>(DIERR_MOREDATA), "DIERR_MOREDATA" },
{ static_cast<HRESULT>(DIERR_NOAGGREGATION), "DIERR_NOAGGREGATION" },
{ static_cast<HRESULT>(DIERR_NOINTERFACE), "DIERR_NOINTERFACE" },
{ static_cast<HRESULT>(DIERR_NOTACQUIRED), "DIERR_NOTACQUIRED" },
...
{ static_cast<HRESULT>(DIERR_NOTFOUND), "DIERR_NOTFOUND" },
{ static_cast<HRESULT>(DIERR_NOTINITIALIZED), "DIERR_NOTINITIALIZED" },
{ static_cast<HRESULT>(DIERR_OBJECTNOTFOUND), "DIERR_OBJECTNOTFOUND" },
{ static_cast<HRESULT>(DIERR_OLDDIRECTINPUTVERSION), "DIERR_OLDDIRECTINPUTVERSION" }, 
{ static_cast<HRESULT>(DIERR_OTHERAPPHASPRIO), "DIERR_OTHERAPPHASPRIO" },
{ static_cast<HRESULT>(DIERR_OUTOFMEMORY), "DIERR_OUTOFMEMORY" },
{ static_cast<HRESULT>(DIERR_READONLY), "DIERR_READONLY" },
{ static_cast<HRESULT>(DIERR_REPORTFULL), "DIERR_REPORTFULL" },
{ static_cast<HRESULT>(DIERR_UNPLUGGED), "DIERR_UNPLUGGED" },
{ static_cast<HRESULT>(DIERR_UNSUPPORTED), "DIERR_UNSUPPORTED" },
{ 0, NULL }
};
